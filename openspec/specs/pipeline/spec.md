...
### Requirement: Explicit FacturaDatos Field Mapping (REQ-FMAP-001)
...
### Requirement: Per-factura Error Isolation (REQ-ISOL-001)
...
### Requirement: Error Count in Response (REQ-ISOL-002)
